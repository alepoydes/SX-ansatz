...
@app.cell
def _(TMP_DIR, s1_nn, step_label, step_um, tv):
...
@app.cell
def _(TMP_DIR, s2_nn, step_label, step_um, tv):
...
@app.cell
def _(TMP_DIR, s3_nn, step_label, step_um, tv):
